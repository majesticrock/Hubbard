...
target_include_directories(hubbard_options INTERFACE EXTRA_INCLUDE_DIRS)

#
# Tell the program where to find the commutator files
#
set(_APPEND_DIR "hubbard")
...
cmake_path(
    ...
    OUTPUT_VARIABLE COMMUTATOR_HUBBARD_DIR
)
# Ensure the path ends in exactly one "/"
string(REGEX REPLACE "/+$" "" COMMUTATOR_HUBBARD_DIR "${COMMUTATOR_HUBBARD_DIR}")
string(APPEND COMMUTATOR_HUBBARD_DIR "/")

message(STATUS "${PROJECT_NAME} will look for the commutator files in ${COMMUTATOR_HUBBARD_DIR}")
target_compile_definitions(hubbard_options INTERFACE COMMUTATOR_DIR="${COMMUTATOR_HUBBARD_DIR}")
...
cmake_path(
    ...
    OUTPUT_VARIABLE OUTPUT_DATA_HUBBARD_DIR
)
# Ensure the path ends in exactly one "/"
string(REGEX REPLACE "/+$" "" OUTPUT_DATA_HUBBARD_DIR "${OUTPUT_DATA_HUBBARD_DIR}")
string(APPEND OUTPUT_DATA_HUBBARD_DIR "/")

message(STATUS "${PROJECT_NAME} saves its data in ${OUTPUT_DATA_HUBBARD_DIR}")
target_compile_definitions(hubbard_options INTERFACE OUTPUT_DATA_DIR="${OUTPUT_DATA_HUBBARD_DIR}")
