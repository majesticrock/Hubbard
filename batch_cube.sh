...
for NEW_VALUE in "${NEW_VALUES[@]}"; do
  ...
  sed -i "s|mpirun ./build/cascadelake/HubbardMeanField params/cluster_cube.config|mpirun ./build/cascadelake/HubbardMeanField cube_auto_generated/$NEW_NAME.config|" cube_auto_generated/$NEW_NAME.slurm
