...
ModelParameters::ModelParameters(coefficient_type _temperature,
                                 coefficient_type _U,
                                 coefficient_type _V,
                                 coefficient_type _global_step,
                                 coefficient_type _second_step,
                                 std::string _global_iterator_type,
                                 std::string _second_iterator_type)
    : global_iterator_type(_global_iterator_type),
      second_iterator_type(_second_iterator_type),
      global_step(_global_step),
      second_step(_second_step),
...
ModelParameters::ModelParameters(const std::vector<coefficient_type>& params,
                                 coefficient_type _global_step,
                                 coefficient_type _second_step,
                                 std::string _global_iterator_type,
                                 std::string _second_iterator_type)
