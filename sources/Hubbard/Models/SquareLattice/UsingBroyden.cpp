...
UsingBroyden::UsingBroyden(const ModelParameters& _params,
                           const BaseAttributes& startingValues,
                           std::size_t MaxPreBroydenIterations)
...
ModelAttributes<global_floating_type> UsingBroyden::computePhases() {
    auto solver = mrock::utility::Selfconsistency::make_broyden<global_floating_type>(this, &this->model_attributes,
                                                                                      _MaxPreBroydenIterations);
